...
def bar_charts():
    ...
    chart4 = Bar("柱状图-标签旋转", width=WIDTH, height=HEIGHT)
    ...
    chart5 = Bar("柱状图-瀑布图", width=WIDTH, height=HEIGHT)
    ...
    chart6 = Bar("柱状图-数据缩放(外)", width=WIDTH, height=HEIGHT)
    ...
    chart7 = Bar("柱状图-数据缩放(外)", width=WIDTH, height=HEIGHT)
    ...
    chart8 = Bar("柱状图-数据缩放(内)", width=1000, height=500)
    ...
    attr = ["{}天".format(i) for i in range(30)]
    v1 = [random.randint(1, 30) for _ in range(30)]
    chart9 = Bar("柱状图-数据缩放(内)", width=WIDTH, height=HEIGHT)
