...
from .constants import RANGE_COLOR, X_TIME, Y_WEEK


def bar3d_charts():
    page = Page()

    chart1 = Bar3D("3D 柱状图示例", width=1000, height=500)
    data = [
