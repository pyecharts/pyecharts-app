...
def map_charts():
    ...
    value = [155, 10, 66, 78]
    attr = ["福建", "山东", "北京", "上海"]
    chart1 = Map("全国地图", width=1200, height=600)
    chart1.add("", attr, value, maptype='china', is_label_show=True)
    page.add(chart1)

    value = [155, 10, 66, 78, 33, 80, 190, 53, 49.6]
    attr = ["福建", "山东", "北京", "上海", "甘肃", "新疆", "河南", "广西", "西藏"]
    chart2 = Map("地图-VisualMap", width=1200, height=600)
    ...
    chart3 = Map("广东地图", width=1200, height=600)
    ...
    chart4 = Map("世界地图", width=1200, height=600)
    ...
    value = [155, 10, 66, 78]
    attr = ["福建", "山东", "北京", "上海"]
    chart5 = Map("全国地图", width=1200, height=600)
